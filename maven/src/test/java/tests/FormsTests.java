...
public class FormsTests extends ElementsThatAllTestsHave {
	...
	static public List<WebElement> errorMessageList;
	static public String[] errorMess = new String[errorMessageList.size()];
	...
	private static void takeTheErrorMessagesFromTheFormSendEmail() throws InterruptedException {
		Thread.sleep(1500);
		errorMessageList = driver.findElements(By.xpath("//div[@id='wpcf7-f7386-o7']//span[@class='wpcf7-not-valid-tip']"));
		for (int i = 0; i < errorMessageList.size(); i++) {
			errorMess[i] = errorMessageList.get(i).getText();
