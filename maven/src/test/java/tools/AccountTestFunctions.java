...
public class AccountTestFunctions {
	...
	static public void checkingValueCrudTest(String FirstName, String LastName, String BdDay, String BdMonth,
			String BdYear, String PhoneNumber) throws InterruptedException {
		System.out.println(" ");
	...
	static public void CheckingTheSearchResults(ArrayList<String> REsults) throws InterruptedException {
		...
		outerloop: for (int j = 0; j < REsults.size();) {
