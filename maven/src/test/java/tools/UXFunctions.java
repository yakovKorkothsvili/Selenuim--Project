...
public class UXFunctions {
	...
	static public void checkingLogoLoctionAndWidthHeight(int xLogo, int ylogo, int widthLogo, int heightLogo) throws InterruptedException {
		Thread.sleep(500);
		System.out.println(" ");
	...
	static public void checkingFontAndColorOf2Links(ArrayList<String>cssElements) throws InterruptedException {
		System.out.println("");
